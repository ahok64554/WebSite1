...
if ('C:\Users\NewRise\Documents\My Web Sites\WebSite1\Azure\vendor/pear-pear.php.net/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\NewRise\Documents\My Web Sites\WebSite1\Azure\vendor/pear-pear.php.net/PEAR '));
    $raw = false;
} else {
